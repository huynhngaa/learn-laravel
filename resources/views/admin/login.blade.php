...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('admin-asset/assets/img/favicon/favicon.ico')}}" />
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('admin-asset/assets/vendor/css/core.css')}}"  class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{asset ('admin-asset/assets/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{asset('admin-asset/assets/css/demo.css')}}" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{asset('admin-asset/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css')}}" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{asset('admin-asset/assets/vendor/css/pages/page-auth.css')}}" />
    <!-- Helpers -->
